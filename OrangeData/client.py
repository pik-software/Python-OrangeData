...
class OrangeDataClient(object):
    ...
    def create_order(self, id_, type_, taxation_system, group=None, key=None, customer_contact=None, callback_url=None):
        """
        Создание чека
        ...
        :type id_: str
        :type type_: int
        :type customer_contact: str or None
    ...
    def create_correction(self, id_, correction_type, type_, description, cause_document_date,
        ...
        if settlement_address:
            self.__correction_request['content']['settlementAddress'] = settlement_address
        if settlement_place:
            self.__correction_request['content']['settlementPlace'] = settlement_place
